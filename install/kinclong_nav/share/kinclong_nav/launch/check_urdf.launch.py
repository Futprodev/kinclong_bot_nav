...
def generate_launch_description():
    ...
    pkg_kinclong_nav = FindPackageShare('kinclong_nav')
    default_rviz_config_path = PathJoinSubstitution([pkg_kinclong_nav, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the kinclong_nav package
